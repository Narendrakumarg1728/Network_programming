...
//        printf ("Verifying the sockfd value for debugging:%d \n ",sockfd);
        ...
        printf("Debug: getting the value htons(portno) : %d", (htons(portno)));
...
/*    printf("Debug: The server address in number entered is: %s",servaddr.sin_addr);  */
//    for ( ; ; ) 
//    {
